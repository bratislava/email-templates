export const kontoTexts = {
  ...
  payment2024: {
    ...
    payFastDigitalyAnywhere: "tento rok máte opäť možnosť zaplatiť svoju daň z nehnuteľností rýchlo a digitálne, kdekoľvek sa nachádzate.",
    infoPayment: '<span style="font-weight: 600;font-size: 16px;line-height: 24px;" class="font-weight-600 font-size-16 line-height-24">Zaplaťte daň z nehnuteľností online,</span> a to platobnou kartou, cez QR kód či prevodom. Detail platby si môžete pozrieť v Bratislavskom konte. Prístup do konta nájdete nižšie.',
    hasEdeskInfo: '{{#if hasEdesk}}<span style="font-weight: 600;font-size: 14px;line-height: 20px;" class="font-weight-600 font-size-14 line-height-20">Keďže máte aktívnu elektronickú schránku, kvôli súčasnej právnej úprave sme povinní Vám doručiť rozhodnutie o dani z nehnuteľností cez slovensko.sk.</span>{{/if}}',
    paymentAmount: "Výsledná suma",
    seeDetailsInAccount: "Všetky potrebné informácie o možnostiach platby ako aj detail Vašej dane z nehnuteľností nájdete vo svojom Bratislavskom konte.",
    seeDetailsInAccountButton: "Zobraziť detail dane v konte",
    seeDetailsInAccountButtonAddress: "https://konto.bratislava.sk",
    payment15days: 'Daň je splatná v termíne <span style="font-weight: 600;font-size: 14px;line-height: 20px;" class="font-weight-600 font-size-14 line-height-20">do 15 dní odo dňa právoplatnosti rozhodnutia {{#if isInstallments}}podľa splátkového kalendára{{/if}}.',
    postDelivery: '{{#if isPostDelivery}}<span style="font-weight: 600;font-size: 14px;line-height: 20px;" class="font-weight-600 font-size-14 line-height-20">Zároveň Vám prostredníctvom pošty doručíme aj rozhodnutie o dani z nehnuteľností do vlastných rúk.</span><br/><br/>Ak by ste sa chceli v budúcnosti návšteve pošty vyhnúť, zvoľte si v Bratislavskom konte doručovanie oznámení o miestnych daniach a poplatkoch už len do Bratislavského konta.{{/if}}'
  }
};
